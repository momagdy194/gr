...
import 'package:untitled2/helpers/url/url.dart';
...
class Attributions extends StatelessWidget {
    ...
    return BaseList(
      children: <Widget>[
        ...
        _buildApisContent(
          ...
          text:
              'The news section is powered by the News API. Tap here to learn more.',
  ...
  Widget _buildApisContent(
      {String title, String text, String url, IconData icon}) {
    return Padding(
